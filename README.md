This object of this App is to provide the user with a facility to view seven day forecasts for cities in OpenWeatherMap API (https://openweathermap.org/api)
